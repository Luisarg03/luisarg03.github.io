...
The /now page presents a living status dashboard: structured focus items with status and optional progress, a visible freshness date, and narrative sections, following the now-page tradition (nownownow.com).
